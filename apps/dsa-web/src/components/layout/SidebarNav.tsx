...
import { BarChart3, BriefcaseBusiness, Home, LogOut, MessageSquareQuote, Settings2, ScanSearch } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'screener', label: '筛选', to: '/screener', icon: ScanSearch },
